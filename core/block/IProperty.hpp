...
//! \class IProperty
//! \brief An interactive property provide elements to dynamically modify a QObject property.
//!
...
public:
    ...
    //! \brief Constructor for type : IPTypeBlock, IPTypeSonBlock and IPTypeBrotherBlock
    //!
